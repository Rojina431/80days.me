                    ...
                    <Fragment key={i}>
                        <div>
                            ...
                            <div className='date-container'>
                                <div className='circle-path' style={{ backgroundColor:`${Colors[i]}` }}></div>
                        ...
                        time={i === 0 ? "Start" : BookedAdventureDetails[i - 1].stay}
                        date={i === 0 ? adv.startDate : `${BookedAdventureDetails[i - 1].startDate} - ${BookedAdventureDetails[i - 1].endDate}`}
                        />
                    </Fragment>
                )
            })
